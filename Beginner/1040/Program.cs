...
namespace _1040
{
    class Program
    {
        ...
        quatro notas de um aluno. Calcule a média com pesos 2, 3, 4 e 1, respectivamente, para cada uma 
        destas notas e mostre esta média acompanhada pela mensagem "Media: ". Se esta média for maior ou 
        igual a 7.0, imprima a mensagem "Aluno aprovado.". Se a média calculada for inferior a 5.0, imprima 
        a mensagem "Aluno reprovado.". Se a média calculada for um valor entre 5.0 e 6.9, inclusive estas, o 
        ...
        static void Main(string[] args)
        {
            ...
            N2 = double.Parse(vetNotas[1], CultureInfo.InvariantCulture);
            N3 = double.Parse(vetNotas[2], CultureInfo.InvariantCulture);
            N4 = double.Parse(vetNotas[3], CultureInfo.InvariantCulture);

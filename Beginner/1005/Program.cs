    ...
    class Program
    {
        static void Main(string[] args)
        {
            /*
                ...
                peso 3.5 e a nota B tem peso 7.5 (A soma dos pesos portanto é 11). Assuma que cada nota 
                ...
                Saída
                    ...
                    igualdade. Utilize variáveis de dupla precisão (double) e como todos os problemas, 
            ...
            */
            ...
            Console.Write("MEDIA = {0}\n", media.ToString("F5", CultureInfo.InvariantCulture));
        }
    }
}